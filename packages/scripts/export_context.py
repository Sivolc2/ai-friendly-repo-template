...
Walk backend & frontend dirs and emit:
  ...
  registry/context.json           - Machine-readable for LLM prompts
"""
import ast
import json
import hashlib
...
BACKEND_PKGS = ["packages/backend"]
FRONTEND_PKGS = ["packages/frontend"]
PIPELINE_DOCS = ["packages/backend/pipelines"]
